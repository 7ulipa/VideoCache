...
Pod::Spec.new do |s|
  s.name             = 'CachableAVAsset'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CachableAVAsset.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'CachableAVAsset/Classes/**/*'
  
  # s.resource_bundles = {
  #   'CachableAVAsset' => ['CachableAVAsset/Assets/*.png']
  # }
